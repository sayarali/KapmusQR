...
import com.alisayar.kapmusqr.databinding.FragmentStudentEditProfileBinding


class StudentEditProfileFragment : Fragment() {


    private lateinit var binding: FragmentStudentEditProfileBinding
    private lateinit var viewModel: StudentEditProfileViewModel
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_student_edit_profile, container, false)
        viewModel = ViewModelProvider(this)[StudentEditProfileViewModel::class.java]
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.ogrenci.observe(viewLifecycleOwner, Observer {
            binding.apply {
                seStudentNoEt.setText(it.studentNo)
                seNameEt.setText(it.name)
                seSurnameEt.setText(it.surname)
                sePhoneNumberEt.setText(it.phoneNumber)
            }
        })
